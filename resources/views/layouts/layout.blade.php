...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar accordion" id="accordionSidebar" style="background: #251B1B; color:#fff;">
            ...
            <a class="sidebar-brand text-white d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-2">INVENTORY </div>
            </a>
